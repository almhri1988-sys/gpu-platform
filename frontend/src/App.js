      ...
      <Card className="w-full max-w-md gpu-card" data-testid="login-card">
        ...
        <CardContent className="space-y-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full btn-neon h-12 text-lg" disabled={loading} data-testid="login-submit-btn">
    ...
    <div className="min-h-screen gradient-mesh flex items-center justify-center px-4" dir="rtl">
      <Card className="w-full max-w-md gpu-card" data-testid="register-card">
        <CardHeader className="text-center">
          ...
          <CardDescription>سجل الآن وابدأ استخدام المنصة</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
